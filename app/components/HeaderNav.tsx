    ...
    >
      <div className="flex justify-between items-center px-6 md:px-10 py-4">
        ...
        <nav
          className={`${
            isOpen ? "block" : "hidden"
          } absolute md:static top-[80px] left-0 w-full md:w-auto md:flex bg-[#8E0EB9] md:bg-transparent px-6 md:px-0 py-4 md:py-0 flex-col md:flex-row gap-6 md:gap-8 text-[#EBEBEB] items-start md:items-center`}
        >
          <p className="my-3">
            <Link to="/" className="hover:text-[#8E0EB9]">
              Home
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#about" className="hover:text-[#8E0EB9]">
              About
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#projects" className="hover:text-[#8E0EB9]">
              Projects
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#team" className="hover:text-[#8E0EB9]">
              Team
            </Link>
          </p>
