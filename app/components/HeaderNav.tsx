  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-6 md:px-10 py-4">
        ...
        >
          <p className="my-3">
            <Link to="/" className="hover:text-[#7B5CFF]">
              Home
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#about" className="hover:text-[#7B5CFF]">
              About
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#projects" className="hover:text-[#7B5CFF]">
              Projects
            </Link>
          </p>
          <p className="my-3">
            <Link to="/#team" className="hover:text-[#7B5CFF]">
              Team
            </Link>
          </p>
